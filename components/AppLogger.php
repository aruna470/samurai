 ...
 * AppLogger class
 *
 * This class will handle application logging. Ex:user activities, API activities etc..
 *
    ...
    function writeLog($message, $params = [], $logLevel = self::INFO)
    {
        ...
        switch($this->logType){
            ...
            case 1:
                ...
                $msg = "{$date}|{$this->username}|{$ip}|{$domain}|{$this->logLevelLabel[$logLevel]}|{$this->action}|" .
                "{$message}|{$data} \n";
            ...
            case 2:
                ...
                $msg = "{$date}|{$this->uniqid}|{$this->username}|{$ip}|{$domain}|{$this->logLevelLabel[$logLevel]}|" .
            ...
            case 3:
                ...
                $date = date('Y-m-d|H:i:s');
                $data = json_encode($params);
                $msg = "{$date}|{$this->uniqid}|{$this->action}|{$this->logLevelLabel[$logLevel]}|{$message}|{$data} \n";
